...
/**
 * Clase que genera una vista en forma de avion para el sensor de posicionamiento vectorial
 */
public class IndicadorAltura extends View {
    ...
    /**
     * Constructor al que le pasamos el context de la vista actual
     * @param context
     */
    public IndicadorAltura(Context context) {
        this(context, null);
    }

    /**
     * Constructor al que le pasamos el context y atributos
    ...
    public IndicadorAltura(Context context, AttributeSet attrs) {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.SRC_IN);//Crea la esfera de vision
        ...
        mPitchLadderPaint = new Paint();//Paint del trazado que indica el cabeceo por encima del horizonte
        mPitchLadderPaint.setAntiAlias(true);
        mPitchLadderPaint.setColor(Color.WHITE);
        mPitchLadderPaint.setStrokeWidth(3);

        mBottomPitchLadderPaint = new Paint();//Paint del trazado que indica el cabeceo por debajo del horizonte
    ...
    /**
     * Seteamos la direccion a la que esta mirando el usuario
     * @param pitch Cabeceo
     * @param roll Balanceo
     */
    ...
    /**
     * A la espera por si cambia el tamaño de la vista
     * @param w Ancho
     * @param h Alto
    ...
    /**
     * Dibujamos el bitmap que compondra el bitmap completo
